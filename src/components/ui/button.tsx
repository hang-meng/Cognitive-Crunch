  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.97]",
  {
    variants: {
      variant: {
        ...
        fitness: "bg-fitness text-fitness-foreground hover:bg-fitness/90 shadow-sm",
        diet: "bg-diet text-diet-foreground hover:bg-diet/90 shadow-sm",
        exercise: "bg-exercise text-exercise-foreground hover:bg-exercise/90 shadow-sm",
        study: "bg-study text-study-foreground hover:bg-study/90 shadow-sm",
